...
private immutable
{
    ...
    string _vendor = "Browser";
    string _processor = "wasm";
    bool _x87onChip;
    bool _mmx;
    bool _sse;
    bool _sse2;
...
version (WASI) {} else: // WASI/WASM doesn't support cpuid
...
pragma(crt_constructor) void cpuid_initialization() pure nothrow @nogc
{
    auto cf = getCpuFeatures();

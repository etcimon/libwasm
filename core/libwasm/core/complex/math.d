...
+/
module libwasm.core.complex.math;

public import libwasm.core.complex;
...
{
    import libwasm.core.math.common: fabs, fmin, fmax, sqrt;
...
{
    import libwasm.core.math.constant: PI, PI_4, PI_2;
    import libwasm.core.math.common: log, fabs, copysign;
    alias isNaN = x => x != x;
...
{
    import libwasm.core.math.common: sqrt;
    import libwasm.core.math.constant: PI;
    import libwasm.core.math.common: approxEqual;
...
@safe pure nothrow @nogc version(mir_core_test) unittest
{
    import libwasm.core.math.common: fabs;
    import libwasm.core.math.constant: PI, PI_2, PI_4;
    alias isNaN = x => x != x;
...
{
    import libwasm.core.math.common: exp, fabs, copysign;
    alias isNaN = x => x != x;
    alias isInfinity = x => x.fabs == T.infinity;

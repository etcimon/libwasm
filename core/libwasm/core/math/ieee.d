 ...
 */
module libwasm.core.math.ieee;

import libwasm.core.internal.utility: isFloatingPoint;
...
do
{
    import libwasm.core.math.common: copysign;
    T x = xx;
    T y = yy;
...
{
    import libwasm.core.math.common: pow, approxEqual;
    alias isNaN = x => x != x;
    int exp;
...
{
    import libwasm.core.math.common: pow;
    int exp;
    real mantissa = frexp(123.456L, exp);
...
@safe pure nothrow @nogc version(mir_core_test) unittest
{
    import libwasm.core.math.common;
    {

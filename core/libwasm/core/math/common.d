...
+/
module libwasm.core.math.common;

import libwasm.core.internal.utility: isComplex, isComplexOf, isFloatingPoint;
...
{
    import libwasm.core.math: PI, feqrel;
...
deprecated("Use libwasm.core.complex.approxEqual instead"):
...
@safe pure nothrow @nogc version(mir_core_test) unittest
{
    import libwasm.core.internal.utility: isComplexOf;

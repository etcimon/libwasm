module spasm.bindings.PaymentRequest;

import spasm.types;
import spasm.bindings.EventHandler;
import spasm.bindings.EventTarget;
import spasm.bindings.PaymentAddress;
import spasm.bindings.PaymentResponse;
...
struct AddressErrors {
  ...
  static auto create() {
    return AddressErrors(spasm_add__object());
  }
...
struct PayerErrors {
  ...
  static auto create() {
    return PayerErrors(spasm_add__object());
  }
...
struct PaymentCurrencyAmount {
  ...
  static auto create() {
    return PaymentCurrencyAmount(spasm_add__object());
  }
...
struct PaymentDetailsBase {
  ...
  static auto create() {
    return PaymentDetailsBase(spasm_add__object());
  }
...
struct PaymentDetailsInit {
  nothrow:
  spasm.bindings.PaymentRequest.PaymentDetailsBase _parent;
  alias _parent this;
  this(Handle h) {
    _parent = .PaymentDetailsBase(h);
  }
  static auto create() {
    return PaymentDetailsInit(spasm_add__object());
  }
  void id()(string id) {
...
struct PaymentDetailsModifier {
  ...
  static auto create() {
    return PaymentDetailsModifier(spasm_add__object());
  }
...
struct PaymentDetailsUpdate {
  ...
  static auto create() {
    return PaymentDetailsUpdate(spasm_add__object());
  }
...
struct PaymentItem {
  ...
  static auto create() {
    return PaymentItem(spasm_add__object());
  }
...
struct PaymentMethodData {
  ...
  static auto create() {
    return PaymentMethodData(spasm_add__object());
  }
  void supportedMethods()(string supportedMethods) {
    Object_Call_string__void(this.handle, "supportedMethods", supportedMethods);
  }
...
struct PaymentOptions {
  ...
  static auto create() {
    return PaymentOptions(spasm_add__object());
  }
  ...
  void shippingType()(PaymentShippingType shippingType) {
    PaymentOptions_shippingType_Set(this.handle, shippingType);
  }
  PaymentShippingType shippingType()() {
    return PaymentOptions_shippingType_Get(this.handle);
  }
}
struct PaymentRequest {
  ...
  auto show()(scope ref Promise!(PaymentDetailsUpdate) detailsPromise) {
    return Promise!(PaymentResponse)(Object_Call_Handle__Handle(this._parent, "show", detailsPromise.handle));
  }
  auto show()() {
    return Promise!(PaymentResponse)(Object_Getter__Handle(this._parent, "show"));
  }
  auto abort()() {
    return Promise!(void)(Object_Getter__Handle(this._parent, "abort"));
  }
  auto canMakePayment()() {
    return Promise!(bool)(Object_Getter__Handle(this._parent, "canMakePayment"));
  }
  string id()() {
    return Object_Getter__string(this._parent, "id");
  }
...
struct PaymentShippingOption {
  ...
  static auto create() {
    return PaymentShippingOption(spasm_add__object());
  }
  void id()(string id) {
...
struct PaymentValidationErrors {
  ...
  static auto create() {
    return PaymentValidationErrors(spasm_add__object());
  }
...
extern (C) void PaymentOptions_shippingType_Set(Handle, PaymentShippingType);
extern (C) PaymentShippingType PaymentOptions_shippingType_Get(Handle);

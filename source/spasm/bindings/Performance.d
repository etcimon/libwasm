module spasm.bindings.Performance;

import spasm.types;
import spasm.bindings.EventHandler;
import spasm.bindings.EventTarget;
import spasm.bindings.PerformanceEntry;
import spasm.bindings.PerformanceNavigation;
import spasm.bindings.PerformanceTiming;
...
struct Performance {
  ...
  void measure()(string measureName, string startMark, string endMark) {
    Performance_measure(this._parent, measureName, startMark, endMark);
  }
...
extern (C) void Performance_measure(Handle, string, string, string);
module spasm.bindings.HTMLObjectElement;
...
struct MozObjectLoadingContent {
  ...
  uint getContentTypeForMIMEType()(string aMimeType) {
    return MozObjectLoadingContent_getContentTypeForMIMEType(this.handle, aMimeType);
  }
  auto getPluginAttributes()() {
  ...
  auto srcURI()() {
    return Object_Getter__OptionalHandle(this.handle, "srcURI");
  }
  uint defaultFallbackType()() {
...
struct MozPluginParameter {
  ...
  static auto create() {
    return MozPluginParameter(spasm_add__object());
  }
  void name()(string name) {
...
extern (C) uint MozObjectLoadingContent_getContentTypeForMIMEType(Handle, string);
module spasm.bindings.ServiceWorkerGlobalScope;
...
struct ServiceWorkerGlobalScope {
  ...
  auto skipWaiting()() {
    return Promise!(void)(Object_Getter__Handle(this._parent, "skipWaiting"));
  }
  void oninstall(T0)(scope auto ref Optional!(T0) oninstall) if (isTOrPointer!(T0, EventHandler)) {
  ...
  void onactivate(T0)(scope auto ref Optional!(T0) onactivate) if (isTOrPointer!(T0, EventHandler)) {
  ...
  void onfetch(T0)(scope auto ref Optional!(T0) onfetch) if (isTOrPointer!(T0, EventHandler)) {
  ...
  void onpush(T0)(scope auto ref Optional!(T0) onpush) if (isTOrPointer!(T0, EventHandler)) {
  ...
  void onpushsubscriptionchange(T0)(scope auto ref Optional!(T0) onpushsubscriptionchange) if (isTOrPointer!(T0, EventHandler)) {
  ...
  void onnotificationclick(T0)(scope auto ref Optional!(T0) onnotificationclick) if (isTOrPointer!(T0, EventHandler)) {
  ...
  void onnotificationclose(T0)(scope auto ref Optional!(T0) onnotificationclose) if (isTOrPointer!(T0, EventHandler)) {

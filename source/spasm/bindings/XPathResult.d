module spasm.bindings.XPathResult;
...
struct XPathResult {
  ...
  auto singleNodeValue()() {
    return Object_Getter__OptionalHandle(this.handle, "singleNodeValue");
  }
  ...
  auto iterateNext()() {
    return Object_Getter__OptionalHandle(this.handle, "iterateNext");
  }
  auto snapshotItem()(uint index) {
    return Object_Call_uint__OptionalHandle(this.handle, "snapshotItem", index);
  }
}

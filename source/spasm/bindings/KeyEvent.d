module spasm.bindings.KeyEvent;
...
struct KeyEvent {
  ...
  void initKeyEvent(T3)(string type, bool canBubble /* = false */, bool cancelable /* = false */, scope auto ref Optional!(T3) view /* = no!(Window) */, bool ctrlKey /* = false */, bool altKey /* = false */, bool shiftKey /* = false */, bool metaKey /* = false */, uint keyCode /* = 0 */, uint charCode /* = 0 */) if (isTOrPointer!(T3, Window)) {
    KeyEvent_initKeyEvent(this.handle, type, canBubble, cancelable, !view.empty, view.front._parent, ctrlKey, altKey, shiftKey, metaKey, keyCode, charCode);
  }
  void initKeyEvent(T3)(string type, bool canBubble /* = false */, bool cancelable /* = false */, scope auto ref Optional!(T3) view /* = no!(Window) */, bool ctrlKey /* = false */, bool altKey /* = false */, bool shiftKey /* = false */, bool metaKey /* = false */, uint keyCode /* = 0 */) if (isTOrPointer!(T3, Window)) {
    KeyEvent_initKeyEvent_0(this.handle, type, canBubble, cancelable, !view.empty, view.front._parent, ctrlKey, altKey, shiftKey, metaKey, keyCode);
  }
  void initKeyEvent(T3)(string type, bool canBubble /* = false */, bool cancelable /* = false */, scope auto ref Optional!(T3) view /* = no!(Window) */, bool ctrlKey /* = false */, bool altKey /* = false */, bool shiftKey /* = false */, bool metaKey /* = false */) if (isTOrPointer!(T3, Window)) {
    KeyEvent_initKeyEvent_1(this.handle, type, canBubble, cancelable, !view.empty, view.front._parent, ctrlKey, altKey, shiftKey, metaKey);
  }
  void initKeyEvent(T3)(string type, bool canBubble /* = false */, bool cancelable /* = false */, scope auto ref Optional!(T3) view /* = no!(Window) */, bool ctrlKey /* = false */, bool altKey /* = false */, bool shiftKey /* = false */) if (isTOrPointer!(T3, Window)) {
    KeyEvent_initKeyEvent_2(this.handle, type, canBubble, cancelable, !view.empty, view.front._parent, ctrlKey, altKey, shiftKey);
  }
  void initKeyEvent(T3)(string type, bool canBubble /* = false */, bool cancelable /* = false */, scope auto ref Optional!(T3) view /* = no!(Window) */, bool ctrlKey /* = false */, bool altKey /* = false */) if (isTOrPointer!(T3, Window)) {
    KeyEvent_initKeyEvent_3(this.handle, type, canBubble, cancelable, !view.empty, view.front._parent, ctrlKey, altKey);
  }
  void initKeyEvent(T3)(string type, bool canBubble /* = false */, bool cancelable /* = false */, scope auto ref Optional!(T3) view /* = no!(Window) */, bool ctrlKey /* = false */) if (isTOrPointer!(T3, Window)) {
    KeyEvent_initKeyEvent_4(this.handle, type, canBubble, cancelable, !view.empty, view.front._parent, ctrlKey);
  }
  void initKeyEvent(T3)(string type, bool canBubble /* = false */, bool cancelable /* = false */, scope auto ref Optional!(T3) view /* = no!(Window) */) if (isTOrPointer!(T3, Window)) {
    KeyEvent_initKeyEvent_5(this.handle, type, canBubble, cancelable, !view.empty, view.front._parent);
  }
  void initKeyEvent()(string type, bool canBubble /* = false */, bool cancelable /* = false */) {
    KeyEvent_initKeyEvent_6(this.handle, type, canBubble, cancelable);
  }
  void initKeyEvent()(string type, bool canBubble /* = false */) {
    KeyEvent_initKeyEvent_7(this.handle, type, canBubble);
  }
  void initKeyEvent()(string type) {
    Object_Call_string__void(this.handle, "initKeyEvent", type);
  }
}


extern (C) void KeyEvent_initKeyEvent(Handle, string, bool, bool, bool, Handle, bool, bool, bool, bool, uint, uint);
extern (C) void KeyEvent_initKeyEvent_0(Handle, string, bool, bool, bool, Handle, bool, bool, bool, bool, uint);
extern (C) void KeyEvent_initKeyEvent_1(Handle, string, bool, bool, bool, Handle, bool, bool, bool, bool);
extern (C) void KeyEvent_initKeyEvent_2(Handle, string, bool, bool, bool, Handle, bool, bool, bool);
extern (C) void KeyEvent_initKeyEvent_3(Handle, string, bool, bool, bool, Handle, bool, bool);
extern (C) void KeyEvent_initKeyEvent_4(Handle, string, bool, bool, bool, Handle, bool);
extern (C) void KeyEvent_initKeyEvent_5(Handle, string, bool, bool, bool, Handle);
extern (C) void KeyEvent_initKeyEvent_6(Handle, string, bool, bool);
extern (C) void KeyEvent_initKeyEvent_7(Handle, string, bool);
module spasm.bindings.HTMLElement;

import spasm.types;
import spasm.bindings.CSSStyleDeclaration;
import spasm.bindings.DOMStringMap;
import spasm.bindings.Element;
import spasm.bindings.EventHandler;
import spasm.bindings.HTMLMenuElement;
...
struct HTMLElement {
  ...
  auto contextMenu()() {
    return Object_Getter__OptionalHandle(this._parent, "contextMenu");
  }
  ...
  auto offsetParent()() {
    return Object_Getter__OptionalHandle(this._parent, "offsetParent");
  }
  int offsetTop()() {

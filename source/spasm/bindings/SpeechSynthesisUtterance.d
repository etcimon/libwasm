module spasm.bindings.SpeechSynthesisUtterance;
...
struct SpeechSynthesisUtterance {
  ...
  void voice(T0)(scope auto ref Optional!(T0) voice) if (isTOrPointer!(T0, SpeechSynthesisVoice)) {
    SpeechSynthesisUtterance_voice_Set(this._parent, !voice.empty, voice.front.handle);
  }
  auto voice()() {
    return Object_Getter__OptionalHandle(this._parent, "voice");
  }
...
extern (C) void SpeechSynthesisUtterance_voice_Set(Handle, bool, Handle);
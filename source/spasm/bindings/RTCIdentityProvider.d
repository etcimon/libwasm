module spasm.bindings.RTCIdentityProvider;

import spasm.types;
@safe:
nothrow:

alias GenerateAssertionCallback = Promise!(RTCIdentityAssertionResult) delegate(string, string, RTCIdentityProviderOptions);
struct RTCIdentityAssertionResult {
  ...
  static auto create() {
    return RTCIdentityAssertionResult(spasm_add__object());
  }
...
struct RTCIdentityProvider {
  ...
  static auto create() {
    return RTCIdentityProvider(spasm_add__object());
  }
...
struct RTCIdentityProviderDetails {
  ...
  static auto create() {
    return RTCIdentityProviderDetails(spasm_add__object());
  }
...
struct RTCIdentityProviderOptions {
  ...
  static auto create() {
    return RTCIdentityProviderOptions(spasm_add__object());
  }
  void protocol()(string protocol) {
    Object_Call_string__void(this.handle, "protocol", protocol);
  }
...
struct RTCIdentityProviderRegistrar {
  ...
  auto generateAssertion()(string contents, string origin, scope ref RTCIdentityProviderOptions options) {
    return Promise!(RTCIdentityAssertionResult)(RTCIdentityProviderRegistrar_generateAssertion(this.handle, contents, origin, options.handle));
  }
  auto generateAssertion()(string contents, string origin) {
    return Promise!(RTCIdentityAssertionResult)(Object_Call_string_string__Handle(this.handle, "generateAssertion", contents, origin));
  }
  auto validateAssertion()(string assertion, string origin) {
    return Promise!(RTCIdentityValidationResult)(Object_Call_string_string__Handle(this.handle, "validateAssertion", assertion, origin));
  }
}
struct RTCIdentityValidationResult {
  ...
  static auto create() {
    return RTCIdentityValidationResult(spasm_add__object());
  }
...
alias ValidateAssertionCallback = Promise!(RTCIdentityValidationResult) delegate(string, string);
...
extern (C) Handle RTCIdentityProviderRegistrar_generateAssertion(Handle, string, string, Handle);
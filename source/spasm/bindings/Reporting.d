module spasm.bindings.Reporting;
...
struct DeprecationReportBody {
  ...
  auto anticipatedRemoval()() {
    return Object_Getter__OptionalHandle(this._parent, "anticipatedRemoval");
  }
  string message()() {
...
struct ReportingEndpoint {
  ...
  static auto create() {
    return ReportingEndpoint(spasm_add__object());
  }
...
struct ReportingHeaderValue {
  ...
  static auto create() {
    return ReportingHeaderValue(spasm_add__object());
  }
...
struct ReportingItem {
  ...
  static auto create() {
    return ReportingItem(spasm_add__object());
  }
...
struct ReportingObserverOptions {
  ...
  static auto create() {
    return ReportingObserverOptions(spasm_add__object());
  }

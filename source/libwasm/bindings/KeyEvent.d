module libwasm.bindings.KeyEvent;
...
struct KeyEvent {
  ...
  void initKeyEvent(T3)(string type, bool canBubble /* = false */, bool cancelable /* = false */, scope auto ref Optional!(T3) view /* = no!(Window) */, bool ctrlKey /* = false */, bool altKey /* = false */, bool shiftKey /* = false */, bool metaKey /* = false */, uint keyCode /* = 0 */, uint charCode /* = 0 */) if (isTOrPointer!(T3, Window)) {
    Serialize_Object_VarArgCall!void(this.handle, "initKeyEvent", "string;bool;bool;Optional!Handle;bool;bool;bool;bool;uint;uint", tuple(type, canBubble, cancelable, !view.empty, cast(Handle)view.front._parent, ctrlKey, altKey, shiftKey, metaKey, keyCode, charCode));
  }
  void initKeyEvent(T3)(string type, bool canBubble /* = false */, bool cancelable /* = false */, scope auto ref Optional!(T3) view /* = no!(Window) */, bool ctrlKey /* = false */, bool altKey /* = false */, bool shiftKey /* = false */, bool metaKey /* = false */, uint keyCode /* = 0 */) if (isTOrPointer!(T3, Window)) {
    Serialize_Object_VarArgCall!void(this.handle, "initKeyEvent", "string;bool;bool;Optional!Handle;bool;bool;bool;bool;uint", tuple(type, canBubble, cancelable, !view.empty, cast(Handle)view.front._parent, ctrlKey, altKey, shiftKey, metaKey, keyCode));
  }
  void initKeyEvent(T3)(string type, bool canBubble /* = false */, bool cancelable /* = false */, scope auto ref Optional!(T3) view /* = no!(Window) */, bool ctrlKey /* = false */, bool altKey /* = false */, bool shiftKey /* = false */, bool metaKey /* = false */) if (isTOrPointer!(T3, Window)) {
    Serialize_Object_VarArgCall!void(this.handle, "initKeyEvent", "string;bool;bool;Optional!Handle;bool;bool;bool;bool", tuple(type, canBubble, cancelable, !view.empty, cast(Handle)view.front._parent, ctrlKey, altKey, shiftKey, metaKey));
  }
  void initKeyEvent(T3)(string type, bool canBubble /* = false */, bool cancelable /* = false */, scope auto ref Optional!(T3) view /* = no!(Window) */, bool ctrlKey /* = false */, bool altKey /* = false */, bool shiftKey /* = false */) if (isTOrPointer!(T3, Window)) {
    Serialize_Object_VarArgCall!void(this.handle, "initKeyEvent", "string;bool;bool;Optional!Handle;bool;bool;bool", tuple(type, canBubble, cancelable, !view.empty, cast(Handle)view.front._parent, ctrlKey, altKey, shiftKey));
  }
  void initKeyEvent(T3)(string type, bool canBubble /* = false */, bool cancelable /* = false */, scope auto ref Optional!(T3) view /* = no!(Window) */, bool ctrlKey /* = false */, bool altKey /* = false */) if (isTOrPointer!(T3, Window)) {
    Serialize_Object_VarArgCall!void(this.handle, "initKeyEvent", "string;bool;bool;Optional!Handle;bool;bool", tuple(type, canBubble, cancelable, !view.empty, cast(Handle)view.front._parent, ctrlKey, altKey));
  }
  void initKeyEvent(T3)(string type, bool canBubble /* = false */, bool cancelable /* = false */, scope auto ref Optional!(T3) view /* = no!(Window) */, bool ctrlKey /* = false */) if (isTOrPointer!(T3, Window)) {
    Serialize_Object_VarArgCall!void(this.handle, "initKeyEvent", "string;bool;bool;Optional!Handle;bool", tuple(type, canBubble, cancelable, !view.empty, cast(Handle)view.front._parent, ctrlKey));
  }
  void initKeyEvent(T3)(string type, bool canBubble /* = false */, bool cancelable /* = false */, scope auto ref Optional!(T3) view /* = no!(Window) */) if (isTOrPointer!(T3, Window)) {
    Serialize_Object_VarArgCall!void(this.handle, "initKeyEvent", "string;bool;bool;Optional!Handle", tuple(type, canBubble, cancelable, !view.empty, cast(Handle)view.front._parent));
  }
  void initKeyEvent()(string type, bool canBubble /* = false */, bool cancelable /* = false */) {
    Serialize_Object_VarArgCall!void(this.handle, "initKeyEvent", "string;bool;bool", tuple(type, canBubble, cancelable));
  }
  void initKeyEvent()(string type, bool canBubble /* = false */) {
    Serialize_Object_VarArgCall!void(this.handle, "initKeyEvent", "string;bool", tuple(type, canBubble));
  }

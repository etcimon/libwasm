...
struct Window {
  ...
  auto document()() {
    return recastOpt!(Document)(Object_Getter__OptionalHandle(this._parent, "document"));
  }
  ...
  auto top()() {
    return recastOpt!(WindowProxy)(Object_Getter__OptionalHandle(this._parent, "top"));
  }
  ...
  auto parent()() {
    return recastOpt!(WindowProxy)(Object_Getter__OptionalHandle(this._parent, "parent"));
  }
  auto frameElement()() {
    return recastOpt!(Element)(Object_Getter__OptionalHandle(this._parent, "frameElement"));
  }
  auto open()(string url /* = "" */, string target /* = "" */, string features /* = "" */) {
    return recastOpt!(WindowProxy)(Serialize_Object_VarArgCall!(Optional!Handle)(this._parent, "open", "string;string;string", tuple(url, target, features)));
  }
  auto open()(string url /* = "" */, string target /* = "" */) {
    return recastOpt!(WindowProxy)(Serialize_Object_VarArgCall!(Optional!Handle)(this._parent, "open", "string;string", tuple(url, target)));
  }
  auto open()(string url /* = "" */) {
    return recastOpt!(WindowProxy)(Object_Call_string__OptionalHandle(this._parent, "open", url));
  }
  auto open()() {
    return recastOpt!(WindowProxy)(Object_Getter__OptionalHandle(this._parent, "open"));
  }
  ...
  void onappinstalled(T0)(scope auto ref Optional!(T0) onappinstalled) if (isTOrPointer!(T0, EventHandlerNonNull)) {
  ...
  auto getSelection()() {
    return recastOpt!(Selection)(Object_Getter__OptionalHandle(this._parent, "getSelection"));
  }
  auto getComputedStyle()(scope ref Element elt, string pseudoElt /* = "" */) {
    return recastOpt!(CSSStyleDeclaration)(Serialize_Object_VarArgCall!(Optional!Handle)(this._parent, "getComputedStyle", "Handle;string", tuple(cast(Handle)elt._parent, pseudoElt)));
  }
  auto getComputedStyle()(scope ref Element elt) {
    return recastOpt!(CSSStyleDeclaration)(Serialize_Object_VarArgCall!(Optional!Handle)(this._parent, "getComputedStyle", "Handle", tuple(cast(Handle)elt._parent)));
  }
  auto matchMedia()(string query) {
    return recastOpt!(MediaQueryList)(Object_Call_string__OptionalHandle(this._parent, "matchMedia", query));
  }
  auto screen()() {
  ...
  auto performance()() {
    return recastOpt!(Performance)(Object_Getter__OptionalHandle(this._parent, "performance"));
  }
  auto getDefaultComputedStyle()(scope ref Element elt, string pseudoElt /* = "" */) {
    return recastOpt!(CSSStyleDeclaration)(Serialize_Object_VarArgCall!(Optional!Handle)(this._parent, "getDefaultComputedStyle", "Handle;string", tuple(cast(Handle)elt._parent, pseudoElt)));
  }
  auto getDefaultComputedStyle()(scope ref Element elt) {
    return recastOpt!(CSSStyleDeclaration)(Serialize_Object_VarArgCall!(Optional!Handle)(this._parent, "getDefaultComputedStyle", "Handle", tuple(cast(Handle)elt._parent)));
  }
  ...
  auto realFrameElement()() {
    return recastOpt!(Element)(Object_Getter__OptionalHandle(this._parent, "realFrameElement"));
  }
  auto docShell()() {
    return recastOpt!(nsIDocShell)(Object_Getter__OptionalHandle(this._parent, "docShell"));
  }
  ...
  void ondevicemotion(T0)(scope auto ref Optional!(T0) ondevicemotion) if (isTOrPointer!(T0, EventHandlerNonNull)) {
  ...
  void ondeviceorientation(T0)(scope auto ref Optional!(T0) ondeviceorientation) if (isTOrPointer!(T0, EventHandlerNonNull)) {
  ...
  void onabsolutedeviceorientation(T0)(scope auto ref Optional!(T0) onabsolutedeviceorientation) if (isTOrPointer!(T0, EventHandlerNonNull)) {
  ...
  void ondeviceproximity(T0)(scope auto ref Optional!(T0) ondeviceproximity) if (isTOrPointer!(T0, EventHandlerNonNull)) {
  ...
  void onuserproximity(T0)(scope auto ref Optional!(T0) onuserproximity) if (isTOrPointer!(T0, EventHandlerNonNull)) {
  ...
  void ondevicelight(T0)(scope auto ref Optional!(T0) ondevicelight) if (isTOrPointer!(T0, EventHandlerNonNull)) {
  ...
  auto openDialog(T3)(string url /* = "" */, string name /* = "" */, string options /* = "" */, scope auto ref T3 extraArguments) {
    ...
    auto result = recastOpt!(WindowProxy)(Serialize_Object_VarArgCall!(Optional!Handle)(this._parent, "openDialog", "string;string;string;Handle", tuple(url, name, options, _handle_extraArguments)));
    dropHandle!(T3)(_handle_extraArguments);
    return result;
  }
  auto content()() {
    return recastOpt!(JsObject)(Object_Getter__OptionalHandle(this._parent, "content"));
  }
  ...
  auto windowRoot()() {
    return recastOpt!(WindowRoot)(Object_Getter__OptionalHandle(this._parent, "windowRoot"));
  }
  ...
  auto InstallTrigger()() {
    return recastOpt!(InstallTriggerImpl)(Object_Getter__OptionalHandle(this._parent, "InstallTrigger"));
  }
  auto windowUtils()() {
  ...
  auto browserDOMWindow()() {
    return recastOpt!(nsIBrowserDOMWindow)(Object_Getter__OptionalHandle(this._parent, "browserDOMWindow"));
  }
  void getAttention()() {
  ...
  void onvrdisplayconnect(T0)(scope auto ref Optional!(T0) onvrdisplayconnect) if (isTOrPointer!(T0, EventHandlerNonNull)) {
  ...
  void onvrdisplaydisconnect(T0)(scope auto ref Optional!(T0) onvrdisplaydisconnect) if (isTOrPointer!(T0, EventHandlerNonNull)) {
  ...
  void onvrdisplayactivate(T0)(scope auto ref Optional!(T0) onvrdisplayactivate) if (isTOrPointer!(T0, EventHandlerNonNull)) {
  ...
  void onvrdisplaydeactivate(T0)(scope auto ref Optional!(T0) onvrdisplaydeactivate) if (isTOrPointer!(T0, EventHandlerNonNull)) {
  ...
  void onvrdisplaypresentchange(T0)(scope auto ref Optional!(T0) onvrdisplaypresentchange) if (isTOrPointer!(T0, EventHandlerNonNull)) {
  ...
  auto sessionStorage()() {
    return recastOpt!(Storage)(Object_Getter__OptionalHandle(this._parent, "sessionStorage"));
  }
  auto localStorage()() {
    return recastOpt!(Storage)(Object_Getter__OptionalHandle(this._parent, "localStorage"));
  }
  auto crypto()() {
  ...
  void ontouchstart(T0)(scope auto ref Optional!(T0) ontouchstart) if (isTOrPointer!(T0, EventHandlerNonNull)) {
  ...
  void ontouchend(T0)(scope auto ref Optional!(T0) ontouchend) if (isTOrPointer!(T0, EventHandlerNonNull)) {
  ...
  void ontouchmove(T0)(scope auto ref Optional!(T0) ontouchmove) if (isTOrPointer!(T0, EventHandlerNonNull)) {
  ...
  void ontouchcancel(T0)(scope auto ref Optional!(T0) ontouchcancel) if (isTOrPointer!(T0, EventHandlerNonNull)) {
...
struct WindowLocalStorage {
  ...
  auto localStorage()() {
    return recastOpt!(Storage)(Object_Getter__OptionalHandle(this.handle, "localStorage"));
  }
}
...
struct WindowSessionStorage {
  ...
  auto sessionStorage()() {
    return recastOpt!(Storage)(Object_Getter__OptionalHandle(this.handle, "sessionStorage"));
  }
}

...
struct NamedNodeMap {
  ...
  auto getNamedItem()(string name) {
    return Optional!(Attr)(Object_Call_string__OptionalHandle(this.handle, "getNamedItem", name));
  }
  auto setNamedItem()(scope ref Attr arg) {
    return Optional!(Attr)(Serialize_Object_VarArgCall!(Optional!Handle)(this.handle, "setNamedItem", "Handle", tuple(cast(Handle)arg._parent)));
  }
  auto removeNamedItem()(string name) {
    return Attr(Object_Call_string__Handle(this.handle, "removeNamedItem", name));
  }
  auto item()(uint index) {
    return Optional!(Attr)(Object_Call_uint__OptionalHandle(this.handle, "item", index));
  }
  uint length()() {
    return Object_Getter__uint(this.handle, "length");
  }
  auto getNamedItemNS(T0)(scope auto ref Optional!(T0) namespaceURI, string localName) if (isTOrPointer!(T0, string)) {
    return Optional!(Attr)(Serialize_Object_VarArgCall!(Optional!Handle)(this.handle, "getNamedItemNS", "Optional!(string);string", tuple(!namespaceURI.empty, namespaceURI.front, localName)));
  }
  auto setNamedItemNS()(scope ref Attr arg) {
    return Optional!(Attr)(Serialize_Object_VarArgCall!(Optional!Handle)(this.handle, "setNamedItemNS", "Handle", tuple(cast(Handle)arg._parent)));
  }

module libwasm.bindings.WebGLRenderingContext;
...
struct ANGLE_instanced_arrays {
  ...
  void drawArraysInstancedANGLE()(uint mode, int first, int count, int primcount) {
    Serialize_Object_VarArgCall!void(this.handle, "drawArraysInstancedANGLE", "uint;int;int;int", tuple(mode, first, count, primcount));
  }
  void drawElementsInstancedANGLE()(uint mode, int count, uint type, int offset, int primcount) {
    Serialize_Object_VarArgCall!void(this.handle, "drawElementsInstancedANGLE", "uint;int;uint;int;int", tuple(mode, count, type, offset, primcount));
  }
  void vertexAttribDivisorANGLE()(uint index, uint divisor) {
    Serialize_Object_VarArgCall!void(this.handle, "vertexAttribDivisorANGLE", "uint;uint", tuple(index, divisor));
  }
}
...
struct EXT_disjoint_timer_query {
  ...
  bool isQueryEXT(T0)(scope auto ref Optional!(T0) query) if (isTOrPointer!(T0, WebGLQuery)) {
    return Serialize_Object_VarArgCall!bool(this.handle, "isQueryEXT", "Optional!Handle", tuple(!query.empty, cast(Handle)query.front.handle));
  }
  void beginQueryEXT()(uint target, scope ref WebGLQuery query) {
    Serialize_Object_VarArgCall!void(this.handle, "beginQueryEXT", "uint;Handle", tuple(target, cast(Handle)query.handle));
  }
  ...
  void queryCounterEXT()(scope ref WebGLQuery query, uint target) {
    Serialize_Object_VarArgCall!void(this.handle, "queryCounterEXT", "Handle;uint", tuple(cast(Handle)query.handle, target));
  }
  auto getQueryEXT()(uint target, uint pname) {
    return Any(Serialize_Object_VarArgCall!Handle(this.handle, "getQueryEXT", "uint;uint", tuple(target, pname)));
  }
  auto getQueryObjectEXT()(scope ref WebGLQuery query, uint pname) {
    return Any(Serialize_Object_VarArgCall!Handle(this.handle, "getQueryObjectEXT", "Handle;uint", tuple(cast(Handle)query.handle, pname)));
  }
}
...
struct OES_vertex_array_object {
  ...
  bool isVertexArrayOES(T0)(scope auto ref Optional!(T0) arrayObject) if (isTOrPointer!(T0, WebGLVertexArrayObject)) {
    return Serialize_Object_VarArgCall!bool(this.handle, "isVertexArrayOES", "Optional!Handle", tuple(!arrayObject.empty, cast(Handle)arrayObject.front.handle));
  }
  void bindVertexArrayOES(T0)(scope auto ref Optional!(T0) arrayObject) if (isTOrPointer!(T0, WebGLVertexArrayObject)) {
    Serialize_Object_VarArgCall!void(this.handle, "bindVertexArrayOES", "Optional!Handle", tuple(!arrayObject.empty, cast(Handle)arrayObject.front.handle));
  }
}
...
struct WEBGL_debug_shaders {
  ...
  string getTranslatedShaderSource()(scope ref WebGLShader shader) {
    return Serialize_Object_VarArgCall!string(this.handle, "getTranslatedShaderSource", "Handle", tuple(cast(Handle)shader.handle));
  }
}
...
struct WebGLContextAttributes {
  ...
  static auto create() {
    return WebGLContextAttributes(libwasm_add__object());
  }
...
struct WebGLRenderingContext {
  ...
  void bufferData(T1)(uint target, scope auto ref Optional!(T1) data, uint usage) if (isTOrPointer!(T1, ArrayBuffer)) {
    Serialize_Object_VarArgCall!void(this.handle, "bufferData", "uint;Optional!Handle;uint", tuple(target, !data.empty, cast(Handle)data.front.handle, usage));
  }
  void bufferData()(uint target, scope ref ArrayBufferView data, uint usage) {
    Serialize_Object_VarArgCall!void(this.handle, "bufferData", "uint;Handle;uint", tuple(target, cast(Handle)data.handle, usage));
  }
  void bufferSubData()(uint target, int offset, scope ref ArrayBuffer data) {
    Serialize_Object_VarArgCall!void(this.handle, "bufferSubData", "uint;int;Handle", tuple(target, offset, cast(Handle)data.handle));
  }
  ...
  void compressedTexImage2D()(uint target, int level, uint internalformat, int width, int height, int border, scope ref ArrayBufferView data) {
    Serialize_Object_VarArgCall!void(this.handle, "compressedTexImage2D", "uint;int;uint;int;int;int;Handle", tuple(target, level, internalformat, width, height, border, cast(Handle)data.handle));
  }
  void compressedTexSubImage2D()(uint target, int level, int xoffset, int yoffset, int width, int height, uint format, scope ref ArrayBufferView data) {
    Serialize_Object_VarArgCall!void(this.handle, "compressedTexSubImage2D", "uint;int;int;int;int;int;uint;Handle", tuple(target, level, xoffset, yoffset, width, height, format, cast(Handle)data.handle));
  }
  void readPixels(T6)(int x, int y, int width, int height, uint format, uint type, scope auto ref Optional!(T6) pixels) if (isTOrPointer!(T6, ArrayBufferView)) {
    Serialize_Object_VarArgCall!void(this.handle, "readPixels", "int;int;int;int;uint;uint;Optional!Handle", tuple(x, y, width, height, format, type, !pixels.empty, cast(Handle)pixels.front.handle));
  }
  ...
  void texImage2D()(uint target, int level, int internalformat, uint format, uint type, scope ref ImageBitmap pixels) {
    Serialize_Object_VarArgCall!void(this.handle, "texImage2D", "uint;int;int;uint;uint;Handle", tuple(target, level, internalformat, format, type, cast(Handle)pixels.handle));
  }
  ...
  void texImage2D()(uint target, int level, int internalformat, uint format, uint type, scope ref HTMLImageElement image) {
    Serialize_Object_VarArgCall!void(this.handle, "texImage2D", "uint;int;int;uint;uint;Handle", tuple(target, level, internalformat, format, type, cast(Handle)image._parent));
  }
  void texImage2D()(uint target, int level, int internalformat, uint format, uint type, scope ref HTMLCanvasElement canvas) {
    Serialize_Object_VarArgCall!void(this.handle, "texImage2D", "uint;int;int;uint;uint;Handle", tuple(target, level, internalformat, format, type, cast(Handle)canvas._parent));
  }
  void texImage2D()(uint target, int level, int internalformat, uint format, uint type, scope ref HTMLVideoElement video) {
    Serialize_Object_VarArgCall!void(this.handle, "texImage2D", "uint;int;int;uint;uint;Handle", tuple(target, level, internalformat, format, type, cast(Handle)video._parent));
  }
  ...
  void texSubImage2D()(uint target, int level, int xoffset, int yoffset, uint format, uint type, scope ref ImageBitmap pixels) {
    Serialize_Object_VarArgCall!void(this.handle, "texSubImage2D", "uint;int;int;int;uint;uint;Handle", tuple(target, level, xoffset, yoffset, format, type, cast(Handle)pixels.handle));
  }
  ...
  void texSubImage2D()(uint target, int level, int xoffset, int yoffset, uint format, uint type, scope ref HTMLImageElement image) {
    Serialize_Object_VarArgCall!void(this.handle, "texSubImage2D", "uint;int;int;int;uint;uint;Handle", tuple(target, level, xoffset, yoffset, format, type, cast(Handle)image._parent));
  }
  void texSubImage2D()(uint target, int level, int xoffset, int yoffset, uint format, uint type, scope ref HTMLCanvasElement canvas) {
    Serialize_Object_VarArgCall!void(this.handle, "texSubImage2D", "uint;int;int;int;uint;uint;Handle", tuple(target, level, xoffset, yoffset, format, type, cast(Handle)canvas._parent));
  }
  void texSubImage2D()(uint target, int level, int xoffset, int yoffset, uint format, uint type, scope ref HTMLVideoElement video) {
    Serialize_Object_VarArgCall!void(this.handle, "texSubImage2D", "uint;int;int;int;uint;uint;Handle", tuple(target, level, xoffset, yoffset, format, type, cast(Handle)video._parent));
  }

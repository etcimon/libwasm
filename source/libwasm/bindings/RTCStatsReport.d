...
nothrow:
  ...
  void rtpContributingSourceStats()(
    scope ref Sequence!(RTCRTPContributingSourceStats) rtpContributingSourceStats)
  {
    Object_Call_Handle__void(this.handle, "rtpContributingSourceStats", rtpContributingSourceStats
        .handle);
  }
  ...
  void trickledIceCandidateStats()(
    scope ref Sequence!(RTCIceCandidateStats) trickledIceCandidateStats)
  {
    Object_Call_Handle__void(this.handle, "trickledIceCandidateStats", trickledIceCandidateStats
        .handle);
  }

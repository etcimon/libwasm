...
struct Event {
  ...
  void initEvent()(string type, bool bubbles /* = false */, bool cancelable /* = false */) {
    Serialize_Object_VarArgCall!void(this.handle, "initEvent", "string;bool;bool", tuple(type, bubbles, cancelable));
  }
  void initEvent()(string type, bool bubbles /* = false */) {
    Serialize_Object_VarArgCall!void(this.handle, "initEvent", "string;bool", tuple(type, bubbles));
  }
...
struct EventInit {
  ...
  static auto create() {
    return EventInit(libwasm_add__object());
  }

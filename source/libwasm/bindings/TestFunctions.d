module libwasm.bindings.TestFunctions;

import libwasm.types;
@safe:
nothrow:

alias PromiseReturner = JsPromise!(Any) delegate();
struct TestFunctions {
  ...
  auto passThroughCallbackPromise()(PromiseReturner callback) {
    return JsPromise!(Any)(TestFunctions_passThroughCallbackPromise(this.handle, callback));
  }

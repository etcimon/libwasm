module libwasm.bindings.FontFace;
...
struct FontFace {
  ...
  auto load()() {
    return JsPromise!(FontFace)(Object_Getter__Handle(this.handle, "load"));
  }
  auto loaded()() {
    return JsPromise!(FontFace)(Object_Getter__Handle(this.handle, "loaded"));
  }
}
struct FontFaceDescriptors {
  ...
  static auto create() {
    return FontFaceDescriptors(libwasm_add__object());
  }
  void style()(string style) {
    Object_Call_string__void(this.handle, "style", style);
  }

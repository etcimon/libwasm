...
struct TextTrackList {
  ...
  auto getTrackById()(string id) {
    return Optional!(TextTrack)(Object_Call_string__OptionalHandle(this._parent, "getTrackById", id));
  }
  ...
  auto mediaElement()() {
    return Optional!(HTMLMediaElement)(Object_Getter__OptionalHandle(this._parent, "mediaElement"));
  }
}

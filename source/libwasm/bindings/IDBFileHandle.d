...
struct IDBFileHandle {
  ...
  auto mutableFile()() {
    return Optional!(IDBMutableFile)(Object_Getter__OptionalHandle(this._parent, "mutableFile"));
  }
  auto fileHandle()() {
    return Optional!(IDBMutableFile)(Object_Getter__OptionalHandle(this._parent, "fileHandle"));
  }
  FileMode mode()() {
  ...
  auto getMetadata()(scope ref IDBFileMetadataParameters parameters) {
    return Optional!(IDBFileRequest)(Serialize_Object_VarArgCall!(Optional!Handle)(this._parent, "getMetadata", "Handle", tuple(cast(Handle)parameters.handle)));
  }
  auto getMetadata()() {
    return Optional!(IDBFileRequest)(Object_Getter__OptionalHandle(this._parent, "getMetadata"));
  }
  auto readAsArrayBuffer()(uint size) {
    return Optional!(IDBFileRequest)(Object_Call_uint__OptionalHandle(this._parent, "readAsArrayBuffer", size));
  }
  auto readAsText(T1)(uint size, scope auto ref Optional!(T1) encoding /* = no!(string) */) if (isTOrPointer!(T1, string)) {
    return Optional!(IDBFileRequest)(Serialize_Object_VarArgCall!(Optional!Handle)(this._parent, "readAsText", "uint;Optional!(string)", tuple(size, !encoding.empty, encoding.front)));
  }
  auto readAsText()(uint size) {
    return Optional!(IDBFileRequest)(Object_Call_uint__OptionalHandle(this._parent, "readAsText", size));
  }
  auto write()(scope ref SumType!(string, ArrayBuffer, ArrayBufferView, Blob) value) {
    return Optional!(IDBFileRequest)(Serialize_Object_VarArgCall!(Optional!Handle)(this._parent, "write", "SumType!(string,Handle,Handle,Handle)", tuple(libwasm.sumtype.match!(((string v) => 0),((ref value.Types[1] v) => 1),((ref value.Types[2] v) => 2),((ref value.Types[3] v) => 3))(value),tuple(libwasm.sumtype.match!(((string v) => v),((ref value.Types[1] v) => string.init),((ref value.Types[2] v) => string.init),((ref value.Types[3] v) => string.init))(value),libwasm.sumtype.match!(((string v) => Handle.init),((ref value.Types[1] v) => cast(Handle)v.handle),((ref value.Types[2] v) => Handle.init),((ref value.Types[3] v) => Handle.init))(value),libwasm.sumtype.match!(((string v) => Handle.init),((ref value.Types[1] v) => Handle.init),((ref value.Types[2] v) => cast(Handle)v.handle),((ref value.Types[3] v) => Handle.init))(value),libwasm.sumtype.match!(((string v) => Handle.init),((ref value.Types[1] v) => Handle.init),((ref value.Types[2] v) => Handle.init),((ref value.Types[3] v) => cast(Handle)v.handle))(value)))));
  }
  auto append()(scope ref SumType!(string, ArrayBuffer, ArrayBufferView, Blob) value) {
    return Optional!(IDBFileRequest)(Serialize_Object_VarArgCall!(Optional!Handle)(this._parent, "append", "SumType!(string,Handle,Handle,Handle)", tuple(libwasm.sumtype.match!(((string v) => 0),((ref value.Types[1] v) => 1),((ref value.Types[2] v) => 2),((ref value.Types[3] v) => 3))(value),tuple(libwasm.sumtype.match!(((string v) => v),((ref value.Types[1] v) => string.init),((ref value.Types[2] v) => string.init),((ref value.Types[3] v) => string.init))(value),libwasm.sumtype.match!(((string v) => Handle.init),((ref value.Types[1] v) => cast(Handle)v.handle),((ref value.Types[2] v) => Handle.init),((ref value.Types[3] v) => Handle.init))(value),libwasm.sumtype.match!(((string v) => Handle.init),((ref value.Types[1] v) => Handle.init),((ref value.Types[2] v) => cast(Handle)v.handle),((ref value.Types[3] v) => Handle.init))(value),libwasm.sumtype.match!(((string v) => Handle.init),((ref value.Types[1] v) => Handle.init),((ref value.Types[2] v) => Handle.init),((ref value.Types[3] v) => cast(Handle)v.handle))(value)))));
  }
  auto truncate()(uint size) {
    return Optional!(IDBFileRequest)(Object_Call_uint__OptionalHandle(this._parent, "truncate", size));
  }
  auto truncate()() {
    return Optional!(IDBFileRequest)(Object_Getter__OptionalHandle(this._parent, "truncate"));
  }
  auto flush()() {
    return Optional!(IDBFileRequest)(Object_Getter__OptionalHandle(this._parent, "flush"));
  }
  void abort()() {

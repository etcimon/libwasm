...
nothrow:
  ...
  {
    Serialize_Object_VarArgCall!void(this.handle, "type", "Optional!(string)", tuple(!type.empty, type
        .front));
  }
  ...
  void l10nAttrs(T0)(scope auto ref Optional!(T0) l10nAttrs)
      if (isTOrPointer!(T0, string))
  {
    Serialize_Object_VarArgCall!void(this.handle, "l10nAttrs", "Optional!(string)", tuple(!l10nAttrs.empty, l10nAttrs
        .front));
  }
  ...
  void l10nArgs(T0)(scope auto ref Optional!(T0) l10nArgs)
      if (isTOrPointer!(T0, JsObject))
  {
    Serialize_Object_VarArgCall!void(this.handle, "l10nArgs", "Optional!Handle", tuple(!l10nArgs.empty, cast(
        Handle) l10nArgs.front.handle));
  }
...
nothrow:
  ...
  {
    Serialize_Object_VarArgCall!void(this.handle, "value", "Optional!(string)", tuple(!value.empty, value
        .front));
  }
  ...
  void attributes(T0)(scope auto ref Optional!(T0) attributes)
      if (isTOrPointer!(T0, Sequence!(AttributeNameValue)))
  {
    Serialize_Object_VarArgCall!void(this.handle, "attributes", "Optional!Handle", tuple(
        !attributes.empty, cast(Handle) attributes.front.handle));
  }

  auto attributes()()
  {
    return recastOpt!(Sequence!(AttributeNameValue))(
      Object_Getter__OptionalHandle(this.handle, "attributes"));
  }
}

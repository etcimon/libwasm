...
struct Document {
  ...
  auto doctype()() {
    return recastOpt!(DocumentType)(Object_Getter__OptionalHandle(this._parent, "doctype"));
  }
  auto documentElement()() {
    return recastOpt!(Element)(Object_Getter__OptionalHandle(this._parent, "documentElement"));
  }
  ...
  auto location()() {
    return recastOpt!(Location)(Object_Getter__OptionalHandle(this._parent, "location"));
  }
  string referrer()() {
  ...
  auto body_()() {
    return recastOpt!(HTMLElement)(Object_Getter__OptionalHandle(this._parent, "body"));
  }
  auto head()() {
    return recastOpt!(HTMLHeadElement)(Object_Getter__OptionalHandle(this._parent, "head"));
  }
  auto images()() {
  ...
  auto defaultView()() {
    return recastOpt!(WindowProxy)(Object_Getter__OptionalHandle(this._parent, "defaultView"));
  }
  bool hasFocus()() {
  ...
  void onbeforescriptexecute(T0)(scope auto ref Optional!(T0) onbeforescriptexecute) if (isTOrPointer!(T0, EventHandlerNonNull)) {
  ...
  void onafterscriptexecute(T0)(scope auto ref Optional!(T0) onafterscriptexecute) if (isTOrPointer!(T0, EventHandlerNonNull)) {
  ...
  void onselectionchange(T0)(scope auto ref Optional!(T0) onselectionchange) if (isTOrPointer!(T0, EventHandlerNonNull)) {
  ...
  auto getBoxObjectFor(T0)(scope auto ref Optional!(T0) element) if (isTOrPointer!(T0, Element)) {
    return recastOpt!(BoxObject)(Serialize_Object_VarArgCall!(Optional!Handle)(this._parent, "getBoxObjectFor", "Optional!Handle", tuple(!element.empty, cast(Handle)element.front._parent)));
  }
  auto currentScript()() {
    return recastOpt!(Element)(Object_Getter__OptionalHandle(this._parent, "currentScript"));
  }
  void releaseCapture()() {
  ...
  auto documentURIObject()() {
    return recastOpt!(URI)(Object_Getter__OptionalHandle(this._parent, "documentURIObject"));
  }
  uint referrerPolicy()() {
  ...
  void onpointerlockchange(T0)(scope auto ref Optional!(T0) onpointerlockchange) if (isTOrPointer!(T0, EventHandlerNonNull)) {
  ...
  void onpointerlockerror(T0)(scope auto ref Optional!(T0) onpointerlockerror) if (isTOrPointer!(T0, EventHandlerNonNull)) {
  ...
  void onvisibilitychange(T0)(scope auto ref Optional!(T0) onvisibilitychange) if (isTOrPointer!(T0, EventHandlerNonNull)) {
  ...
  auto caretPositionFromPoint()(float x, float y) {
    return recastOpt!(CaretPosition)(Serialize_Object_VarArgCall!(Optional!Handle)(this._parent, "caretPositionFromPoint", "float;float", tuple(x, y)));
  }
  auto scrollingElement()() {
    return recastOpt!(Element)(Object_Getter__OptionalHandle(this._parent, "scrollingElement"));
  }
  ...
  auto rootElement()() {
    return recastOpt!(SVGSVGElement)(Object_Getter__OptionalHandle(this._parent, "rootElement"));
  }
  auto getAnonymousNodes()(scope ref Element elt) {
    return recastOpt!(NodeList)(Serialize_Object_VarArgCall!(Optional!Handle)(this._parent, "getAnonymousNodes", "Handle", tuple(cast(Handle)elt._parent)));
  }
  auto getAnonymousElementByAttribute()(scope ref Element elt, string attrName, string attrValue) {
    return recastOpt!(Element)(Serialize_Object_VarArgCall!(Optional!Handle)(this._parent, "getAnonymousElementByAttribute", "Handle;string;string", tuple(cast(Handle)elt._parent, attrName, attrValue)));
  }
  auto getBindingParent()(scope ref Node node) {
    return recastOpt!(Element)(Serialize_Object_VarArgCall!(Optional!Handle)(this._parent, "getBindingParent", "Handle", tuple(cast(Handle)node._parent)));
  }
  ...
  auto documentLoadGroup()() {
    return recastOpt!(nsILoadGroup)(Object_Getter__OptionalHandle(this._parent, "documentLoadGroup"));
  }
  ...
  auto mozDocumentURIIfNotForErrorPages()() {
    return recastOpt!(URI)(Object_Getter__OptionalHandle(this._parent, "mozDocumentURIIfNotForErrorPages"));
  }
  ...
  auto commandDispatcher()() {
    return recastOpt!(XULCommandDispatcher)(Object_Getter__OptionalHandle(this._parent, "commandDispatcher"));
  }
  ...
  auto popupNode()() {
    return recastOpt!(Node)(Object_Getter__OptionalHandle(this._parent, "popupNode"));
  }
  auto popupRangeParent()() {
    return recastOpt!(Node)(Object_Getter__OptionalHandle(this._parent, "popupRangeParent"));
  }
  ...
  auto tooltipNode()() {
    return recastOpt!(Node)(Object_Getter__OptionalHandle(this._parent, "tooltipNode"));
  }
  ...
  auto l10n()() {
    return recastOpt!(DocumentL10n)(Object_Getter__OptionalHandle(this._parent, "l10n"));
  }
  auto policy()() {

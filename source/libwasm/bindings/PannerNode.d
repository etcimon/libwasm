module libwasm.bindings.PannerNode;
...
struct PannerNode {
  ...
  void panningModel()(PanningModelType panningModel) {
    Object_Call_int__void(this._parent, "panningModel", panningModel);
  }
  PanningModelType panningModel()() {
    return Object_Getter__int(this._parent, "panningModel");
  }
  void setPosition()(double x, double y, double z) {
    Serialize_Object_VarArgCall!void(this._parent, "setPosition", "double;double;double", tuple(x, y, z));
  }
  void setOrientation()(double x, double y, double z) {
    Serialize_Object_VarArgCall!void(this._parent, "setOrientation", "double;double;double", tuple(x, y, z));
  }
  auto positionX()() {
  ...
  void distanceModel()(DistanceModelType distanceModel) {
    Object_Call_int__void(this._parent, "distanceModel", distanceModel);
  }
  DistanceModelType distanceModel()() {
    return Object_Getter__int(this._parent, "distanceModel");
  }
...
struct PannerOptions {
  ...
  static auto create() {
    return PannerOptions(libwasm_add__object());
  }
  void panningModel()(PanningModelType panningModel) {
    Object_Call_int__void(this._parent, "panningModel", panningModel);
  }

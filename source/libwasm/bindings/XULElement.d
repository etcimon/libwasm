module libwasm.bindings.XULElement;
...
struct XULElement {
  ...
  void flex()(string flex) {
    Object_Call_string__void(this._parent, "flex", flex);
  }
  string flex()() {
    return Object_Getter__string(this._parent, "flex");
  }
  void ordinal()(string ordinal) {
    Object_Call_string__void(this._parent, "ordinal", ordinal);
  }
  string ordinal()() {
    return Object_Getter__string(this._parent, "ordinal");
  }
  void orient()(string orient) {
    Object_Call_string__void(this._parent, "orient", orient);
  }
  string orient()() {
    return Object_Getter__string(this._parent, "orient");
  }
  void pack()(string pack) {
    Object_Call_string__void(this._parent, "pack", pack);
  }
  string pack()() {
    return Object_Getter__string(this._parent, "pack");
  }
  void hidden()(bool hidden) {
    Object_Call_bool__void(this._parent, "hidden", hidden);
  }
  bool hidden()() {
  ...
  void observes()(string observes) {
    Object_Call_string__void(this._parent, "observes", observes);
  }
  string observes()() {
    return Object_Getter__string(this._parent, "observes");
  }
  void menu()(string menu) {
    Object_Call_string__void(this._parent, "menu", menu);
  }
  string menu()() {
    return Object_Getter__string(this._parent, "menu");
  }
  void contextMenu()(string contextMenu) {
    Object_Call_string__void(this._parent, "contextMenu", contextMenu);
  }
  string contextMenu()() {
    return Object_Getter__string(this._parent, "contextMenu");
  }
  void tooltip()(string tooltip) {
    Object_Call_string__void(this._parent, "tooltip", tooltip);
  }
  string tooltip()() {
    return Object_Getter__string(this._parent, "tooltip");
  }
  ...
  void minWidth()(string minWidth) {
    Object_Call_string__void(this._parent, "minWidth", minWidth);
  }
  string minWidth()() {
    return Object_Getter__string(this._parent, "minWidth");
  }
  void minHeight()(string minHeight) {
    Object_Call_string__void(this._parent, "minHeight", minHeight);
  }
  string minHeight()() {
    return Object_Getter__string(this._parent, "minHeight");
  }
  void maxWidth()(string maxWidth) {
    Object_Call_string__void(this._parent, "maxWidth", maxWidth);
  }
  string maxWidth()() {
    return Object_Getter__string(this._parent, "maxWidth");
  }
  void maxHeight()(string maxHeight) {
    Object_Call_string__void(this._parent, "maxHeight", maxHeight);
  }
  string maxHeight()() {
    return Object_Getter__string(this._parent, "maxHeight");
  }
  void left()(string left) {
    Object_Call_string__void(this._parent, "left", left);
  }
  string left()() {
    return Object_Getter__string(this._parent, "left");
  }
  void top()(string top) {
    Object_Call_string__void(this._parent, "top", top);
  }
  string top()() {
    return Object_Getter__string(this._parent, "top");
  }
  int screenX()() {
  ...
  void tooltipText()(string tooltipText) {
    Object_Call_string__void(this._parent, "tooltipText", tooltipText);
  }
  string tooltipText()() {
    return Object_Getter__string(this._parent, "tooltipText");
  }
  void src()(string src) {
  ...
  void allowEvents()(bool allowEvents) {
    Object_Call_bool__void(this._parent, "allowEvents", allowEvents);
  }
  bool allowEvents()() {
    return Object_Getter__bool(this._parent, "allowEvents");
  }
  auto controllers()() {
    return XULControllers(Object_Getter__Handle(this._parent, "controllers"));
  }
  auto boxObject()() {
    return recastOpt!(BoxObject)(Object_Getter__OptionalHandle(this._parent, "boxObject"));
  }
  ...
  void click()() {
    Object_Call__void(this._parent, "click");
  }
  void doCommand()() {
    Object_Call__void(this._parent, "doCommand");
  }
  auto style()() {
    return CSSStyleDeclaration(Object_Getter__Handle(this._parent, "style"));
  }
  bool hasMenu()() {
    return Object_Getter__bool(this._parent, "hasMenu");
  }
  void openMenu()(bool open) {
    Object_Call_bool__void(this._parent, "openMenu", open);
  }

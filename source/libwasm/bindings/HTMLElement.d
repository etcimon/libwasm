module libwasm.bindings.HTMLElement;
...
import libwasm.bindings.HTMLMenuElement;
...
struct HTMLElement {
  ...
  void innerText()(string innerText) {
    Object_Call_string__void(this._parent, "innerText", innerText);
  }
  string innerText()() {
    return Object_Getter__string(this._parent, "innerText");
  }
  ...
  void accessKey()(string accessKey) {
    Object_Call_string__void(this._parent, "accessKey", accessKey);
  }
  string accessKey()() {
    return Object_Getter__string(this._parent, "accessKey");
  }
  string accessKeyLabel()() {
    return Object_Getter__string(this._parent, "accessKeyLabel");
  }
  void draggable()(bool draggable) {
    Object_Call_bool__void(this._parent, "draggable", draggable);
  }
  bool draggable()() {
    return Object_Getter__bool(this._parent, "draggable");
  }
  void contentEditable()(string contentEditable) {
    Object_Call_string__void(this._parent, "contentEditable", contentEditable);
  }
  string contentEditable()() {
    return Object_Getter__string(this._parent, "contentEditable");
  }
  bool isContentEditable()() {
    return Object_Getter__bool(this._parent, "isContentEditable");
  }
  auto contextMenu()() {
    return recastOpt!(HTMLMenuElement)(Object_Getter__OptionalHandle(this._parent, "contextMenu"));
  }
  void spellcheck()(bool spellcheck) {
    Object_Call_bool__void(this._parent, "spellcheck", spellcheck);
  }
  bool spellcheck()() {
    return Object_Getter__bool(this._parent, "spellcheck");
  }
  auto style()() {
    return CSSStyleDeclaration(Object_Getter__Handle(this._parent, "style"));
  }
  auto offsetParent()() {
    return recastOpt!(Element)(Object_Getter__OptionalHandle(this._parent, "offsetParent"));
  }
  int offsetTop()() {
    return Object_Getter__int(this._parent, "offsetTop");
  }
  int offsetLeft()() {
    return Object_Getter__int(this._parent, "offsetLeft");
  }
  int offsetWidth()() {
    return Object_Getter__int(this._parent, "offsetWidth");
  }
  int offsetHeight()() {
    return Object_Getter__int(this._parent, "offsetHeight");
  }
...
struct TouchEventHandlers {
  ...
  void ontouchstart(T0)(scope auto ref Optional!(T0) ontouchstart) if (isTOrPointer!(T0, EventHandlerNonNull)) {
    Object_Call_EventHandler__void(this.handle, "ontouchstart", !ontouchstart.empty, ontouchstart.front);
  }
  EventHandler ontouchstart()() {
    return Object_Getter__EventHandler(this.handle, "ontouchstart");
  }
  void ontouchend(T0)(scope auto ref Optional!(T0) ontouchend) if (isTOrPointer!(T0, EventHandlerNonNull)) {
    Object_Call_EventHandler__void(this.handle, "ontouchend", !ontouchend.empty, ontouchend.front);
  }
  EventHandler ontouchend()() {
    return Object_Getter__EventHandler(this.handle, "ontouchend");
  }
  void ontouchmove(T0)(scope auto ref Optional!(T0) ontouchmove) if (isTOrPointer!(T0, EventHandlerNonNull)) {
    Object_Call_EventHandler__void(this.handle, "ontouchmove", !ontouchmove.empty, ontouchmove.front);
  }
  EventHandler ontouchmove()() {
    return Object_Getter__EventHandler(this.handle, "ontouchmove");
  }
  void ontouchcancel(T0)(scope auto ref Optional!(T0) ontouchcancel) if (isTOrPointer!(T0, EventHandlerNonNull)) {
    Object_Call_EventHandler__void(this.handle, "ontouchcancel", !ontouchcancel.empty, ontouchcancel.front);
  }
  EventHandler ontouchcancel()() {
    return Object_Getter__EventHandler(this.handle, "ontouchcancel");
  }
}

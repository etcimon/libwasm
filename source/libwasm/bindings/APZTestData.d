module libwasm.bindings.APZTestData;
...
struct APZBucket {
  ...
  static auto create() {
    return APZBucket(libwasm_add__object());
  }
...
struct APZHitResult {
  ...
  static auto create() {
    return APZHitResult(libwasm_add__object());
  }
  ...
  void hitResult()(ushort hitResult) {
    Serialize_Object_VarArgCall!void(this.handle, "hitResult", "ushort", tuple(hitResult));
  }
  ushort hitResult()() {
...
struct APZTestData {
  ...
  static auto create() {
    return APZTestData(libwasm_add__object());
  }
...
struct FrameUniformity {
  ...
  static auto create() {
    return FrameUniformity(libwasm_add__object());
  }
...
struct FrameUniformityResults {
  ...
  static auto create() {
    return FrameUniformityResults(libwasm_add__object());
  }
...
struct ScrollFrameData {
  ...
  static auto create() {
    return ScrollFrameData(libwasm_add__object());
  }
  void scrollId()(uint scrollId) {
    Object_Call_uint__void(this.handle, "scrollId", scrollId);
  }
...
struct ScrollFrameDataEntry {
  ...
  static auto create() {
    return ScrollFrameDataEntry(libwasm_add__object());
  }
  void key()(string key) {

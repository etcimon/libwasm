...
enum terminal_text_title = only(l(0,"> UNDERRUN"),
                            l(20,">  "),
...
enum terminal_text_story = only(l(0,"> DATE: SEP. 13, 2718 - 13:32"),
...
enum terminal_text_outro = only(l(0,"> ALL SATELLITE LINKS ONLINE"),
                            l(1,"> CONNECTING..."),
...
void terminal_write_text(LineRange)(ref Terminal terminal, LineRange lines, TerminalCallback callback = null) @trusted {
  auto writer = allocator.make!(TerminalWriter!(LineRange))(&terminal, lines, callback);
  writer.writeLine();
}

auto terminal_show_notice(LineRange)(ref Terminal terminal, LineRange notice, TerminalCallback callback = null) @trusted {
...
auto terminal_run_intro(ref Terminal terminal) @trusted {
  terminal.clear();
  static struct Handler {
    nothrow:
    @safe:
...
auto terminal_run_garbage(ref Terminal terminal) @trusted {
